...
public class RenderUtil implements Util
{
    ...
    public static void drawBoxESPS(final BlockPos pos, final Color color, final float lineWidth, final boolean outline, final boolean box, final int boxAlpha, final float height) {
