...
import sn0w.features.gui.components.Component;
...
public class Slider
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        OyVey.textManager.drawStringWithShadow(this.getName() + " " + ChatFormatting.GRAY + (this.setting.getValue(true) instanceof Float ? this.setting.getValue(true) : Double.valueOf(((Number) this.setting.getValue(true)).doubleValue())), this.x + 2.3f, this.y - 1.7f - (float) OyVeyGui.getClickGui().getTextOffset(), -1);
    }
