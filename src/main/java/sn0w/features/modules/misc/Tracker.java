...
import sn0w.event.events.DeathEvent;
...
public class Tracker
    ...
    public int onUpdate() {
        if (this.trackedPlayer == null) {
            ...
            Command.sendMessage(TextUtil.coloredString(this.trackedPlayer.getName() + " has used " + this.usedStacks + " stacks of XP!", HUD.getInstance()));
        }
        return 0;
    }
