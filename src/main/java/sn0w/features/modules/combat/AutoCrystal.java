...
import sn0w.features.modules.misc.AutoGG;
...
public class AutoCrystal
    ...
    public void onCrystal() {
        ...
        if (this.crystal != null && this.explode.getValue(true).booleanValue() && this.breakTimer.passedMs(this.breakDelay.getValue(true).longValue())) {
            this.breakTimer.reset();
        ...
        if (this.placeTimer.passedMs(this.placeDelay.getValue(true).longValue()) && this.place.getValue(true).booleanValue()) {
            this.placeTimer.reset();
            double damage = 0.5;
            for (BlockPos blockPos : this.placePostions(this.placeRange.getValue(true).floatValue())) {
                double selfDmg;
                double targetRange;
            ...
            if (this.hotBarSlot != -1 && this.autoswitch.getValue(true).booleanValue() && !AutoCrystal.mc.player.isPotionActive(MobEffects.WEAKNESS)) {
